...
annotations to applications. If the head of an application is a function from
...
Lemma expand_term_with_subst : forall M n, (M ↑ 1 # (S n)) [ n ← #0 ] = M.
  ...
  - simpl. rewrite IHM1. rewrite IHM2. reflexivity.
  - simpl. rewrite IHM1. rewrite IHM2. rewrite IHM3. rewrite IHM4. rewrite IHM5. rewrite IHM6. reflexivity.
Qed.
