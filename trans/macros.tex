...
\newcommand\sB{s_{\mB}}
\newcommand\sR{s_{\mR}}
\DeclareMathOperator{\mbA}{\mA^\bullet}
...
\DeclareMathOperator{\mrho}{\pmb{\bm{\rho}}}
% \newcommand\tr[1]{\llbracket #1 \rrbracket}
\newcommand\tr[2]{\den{#1}_{#2}}
\newcommand\prfl{\mrho}
% \newcommand\pfull{[\mA,\mB,\me]}
\newcommand\pfull{\msigma}
\newcommand\pany{[\mbA,\mbB,\mbe]}
