...
\begin{document}
  ...
  \begin{proof}
    ...
    \begin{caselist}
      ...
      translation. By lemma~\ref{lem:transleq}, we have $\Gamma' \dere A'' : s$
      which is still a valid translation. So $\dere \Gamma', x : A''$ and
      $\Gamma', x : A''$ is a translation of $\Gamma, x : A$.
