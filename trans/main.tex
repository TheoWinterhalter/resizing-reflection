...
\begin{document}
  ...
  \[
    \de(C,b) :=
      \J(s, \lambda \_, \mbB, \mbe. C, \lambda A. b, \mA, \mbB, \mbe).
  \]
  \meta{What should I quantify over in $b$?}

  \meta{Below, $\Gamma \msigma$ doesn't really make sens, should I say for any
  $\Delta$ such that $\Delta \derb \msigma : \Gamma$?}
  ...
  \begin{definition}[$\Gamma$-translation]
    ...
    \begin{itemize}
      ...
      \item $t$ is a $\Gamma$-translation of $\mR$ if
            $\Gamma \msigma \derb t \msigma = B' \msigma$ where $B'$ is a
            $\Gamma$-translation of $\mB$.
      \item $t$ is a $\Gamma$-translation of $\inj(u)$ if
            $\Gamma \msigma \derb t \msigma = \me_*\ u'\msigma$ where $u'$ is a
            $\Gamma$-translation of $u$.
      \item $t$ is a $\Gamma$-translation of $\proj(u)$ if
            $\Gamma \msigma \derb t \msigma = {\me\inv}_*\ u'\msigma$ where $u'$
            is a $\Gamma$-translation of $u$.
    \end{itemize}
  \end{definition}
