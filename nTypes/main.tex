...
\begin{document}
  ...
  \meta{TODO: Add definitional equality}
  ...
  Throughout this paper, the induction measure $A \in \Hu_n$ shall mean the
  minimum height of a derivation of $(A, \mathcal{A}) \in \Hu_n$ for some
  $\mathcal{A}$.
  Note that we also have that $A \in \Hu_n$ is smaller than $\Hu_n \in \Hu_m$.
  We also write $A \in h$ for $A \in \Hu_n$ for some $n$.

  \meta{How to speak about $\gettype$ for instance?}
  ...
  \meta{Sigma member rule, $hSr$ rule, $\nType{n}$ rules}
