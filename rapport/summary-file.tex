...
\begin{definition}[Translation]
  ...
  \begin{itemize}
    ...
    \item $\der \overline{\Gamma}, x:\overline{T} \in \den{\der \Gamma, x:T}$
          when $\der \overline{\Gamma} \in \den{\dere \Gamma}$ and
          $\overline{T} \sim T$.
    \item $\overline{\Gamma} \der \overline{t} : \overline{T}$ when
          $\der \overline{\Gamma} \in \den{\dere \Gamma}$ and
          $\overline{t} \sim t$ and $\overline{T} \sim T$.
  \end{itemize}
\end{definition}
