...
\begin{document}
  ...
  \begin{mathc}
    \tru{\Gamma \der e : \Id (\Pi x:U.T)\ f\ f'
       ...
       }{\Delta \der \hideq{\app e\ p} f\ u \hEr f'\ u' : T[u/x]
       }{\Gamma \der \hideq{e} f \Er f' : \Pi x:U.T}
  \end{mathc}

  \begin{mathc}
    \tru{\Gamma \der e : \Id (\Id T\ u\ v)\ f\ f'
       }{\forall T,T',U,U',b,b',u',v' \text{ with the expected conversions }
         \gives
       }{\Gamma \der \J(T,U,b,u,v,f) \hEr \J(T',U',b',u',v',f')
       }{\Gamma \der \hideq{e} f \Er f' : \Id T\ u\ v}
  \end{mathc}
    ...
    \begin{caselist}
      ...
      \begin{mathc}
        \tru{\Gamma \der e : \Id (\Pi x:U.V)\ f\ f'
           }{\forall \Delta \le \Gamma, \Delta \der \hideq{r} u \hEr u' : U
             \gives
             \Delta \der u = u' : U \gives
           }{\Delta \der \hideq{\app e\ r} f\ u \hEr f'\ u' : V[u/x]
  ...
  \begin{lemma}[Validity of $\refl$ equality]
    \leavevmode
    \begin{mathc}
      \ru{\Gamma \Der t = t' : T \qquad
        }{\Gamma \Der \refl_t = \refl_{t'} : \Id T\ t\ t}
  ...
  \begin{lemma}[Validity of $\seq$ equality]
    \leavevmode
    \begin{mathc}
      \ru{\Gamma \Der T = T' : s \qquad
          \Gamma \Der t = t' : \squash{T} \qquad
  ...
  \begin{proof}
    ...
    f \sigma\ t \sigma \hEr
    f \sigma'\ t \sigma' : T \sigma$.
    This is done by instantiation of the hypotheses regarging $f$ and $t$.
  \end{proof}
  ...
  \begin{proof}
    ...
    \begin{caselist}
      ...
      \meta{This is actually not true, since for $\Pi$-types and identities we
      expect more now... And I don't see any way to conclude.}
  ...
  \begin{proof}
    ...
    All the compatibility rules with a type $T \nequiv s, \Pi \_, \Id \_$ are
    handled by $\refl$, compatibility for types is also direct.
