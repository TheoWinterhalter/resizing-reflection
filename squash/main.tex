...
\begin{document}
  ...
  Before stating conversion, we should remark that the relation $\Er$ on
  weak-head normal types also contains a proof of equality.
  We will, as for $\hEr$ write $\Gamma \der \hideq{p} A \Er A' : s$.
