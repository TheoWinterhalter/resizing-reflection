...
\begin{document}
  ...
  We write $\Gamma \der \hideq{p} t \hEr t' : T$ when $p$ is the underlying
  proof of equality contained in $\Gamma \der t \hEr t' : T$.
  ...
  \begin{center}
  \(
    \dru{\forall \Delta \le \Gamma,\ \Delta \der \hideq{p} u \hEr u' : U \gives
         \Delta \der f~u \hEr ((\ap (\lambda x.V)\ p)\inv)_*\ f'~u' : V[u/x]
  ...
  \(
    \trux{\Gamma \der U \hEr U' : s
          ...
          \Delta \der V[u/x] \hEr V'[u'/x] : s'
        }{\Gamma \der e : \Id s''\ (\Sigma x:U.V)\ (\Sigma x:U'.V')
        }{\Gamma \der \Sigma x:U.V \Er \Sigma x:U'.V' : s''
        }{(s,s',s'')}
  \)
  \end{center}
  ...
  \begin{center}
  \(
    \dru{\Gamma \der \hideq{p} f.1 \hEr f'.1 : U \qquad
         \Gamma \der f.2 \hEr ((\ap (\lambda x.V)\ p)\inv)_*\ f'.2 : V[f.1/x]
       }{\Gamma \der e : \Id (\Sigma x:U.V)\ f\ f'
       }{\Gamma \der f \Er f' : \Sigma x:U.V}
  \)
  \end{center}

  \begin{mathc}
    \ru{\Gamma \der \hideq{p} T \hEr T' : s \qquad
        \Gamma \der u \hEr (p\inv)_*\ u' : T \qquad
        \Gamma \der v \hEr (p\inv)_*\ v' : T
      }{\Gamma \der \Id T\ u\ v \Er \Id T'\ u'\ v' : s}
  \end{mathc}

  \begin{mathc}
    \ru{\Gamma \der e : \Id (\Id T\ u\ v)\ f\ f'
      }{\Gamma \der f \Er f' : \Id T\ u\ v}
  \end{mathc}
  ...
  \begin{lemma}[Type Conversion]
    ...
    \leavevmode
    \begin{itemize}
      \item If $\Gamma \der A \Er A' : s$ then
      $\Gamma \der a \Er a' : A$ iff $\Gamma \der a \Er a' : A'$.
      \item If $\Gamma \der T \hEr T' : s$ then
      $\Gamma \der t \hEr t : T$ iff $\Gamma \der t \Er t' : T'$.
    \end{itemize}
  \end{lemma}
  ...
  \begin{proof}
    ...
    \begin{caselist}
      ...
      \begin{center}
      \(
        \dru{\forall \Delta \le \Gamma,\ \Delta \der u \hEr u' : U \gives
             \Delta \der f~u \hEr f'~u' : V[u/x]
           }{\Gamma \der e : \Id (\Pi x:U.V)\ f\ f'
           }{\Gamma \der f \Er f' : \Pi x:U.V}
      \)
      \end{center}
      \meta{Assuming $\Gamma \der e : \Id (\Pi x:U.V)\ f\ f'$, isn't the type
      $\Id (\Pi x:U'.V')\ f\ f'$ ill-typed?}
      ...
      result. \meta{Same here, we no longer have an hypothesis strong enough
      to call conversion.}
    \end{caselist}
  \end{proof}
  ...
  \begin{mathc}
    ...
    \dru{\Der \Gamma \qquad
         \Der \Gamma'
       }{\forall \Delta \der \rho \hEr \rho' : \Gamma'.\ %
         \Delta \der \sigma \rho \hEr \sigma' \rho' : \Gamma'
