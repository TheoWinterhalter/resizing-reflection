...
\begin{document}
  ...
  \meta{Who is the underlying equality here?}
  ...
  \meta{We should label the equality here to show some action of the
  ...
  \begin{proof}
    ...
    (\meta{how? I actually need to be able to derive that the application
    whr to something})
