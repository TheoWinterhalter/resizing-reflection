...
\begin{document}
  ...
  \(
    ...
    \qquad
    \ru{\Gamma \der \red t \hsteq \red t' : \_
      }{\Gamma \der t \iff t' : N}
    \qquad
  ...
  \begin{center}
  \(
    \ru{\Gamma \der t \hindeq t' : u =_T v
      }{\Gamma \der t \iff t' : u =_T v}
    \qquad
  ...
  \paradot{Inductive Equality}

  \begin{center}
  \(
    \ru{\Gamma \der \red t \indeq t' : T
      }{\Gamma \der t \hindeq t' : T}
    \qquad
    \ru{\Gamma \der n \steq n' : \_
      }{\Gamma \der n \indeq n' : T}
    \qquad
    \ru{\Gamma \der t \hiff t' : T
      }{\Gamma \der \refl_t \indeq \refl_{t'} : u =_T v}
  \)
  \end{center}
  ...
  \begin{center}
  \(
    \tru{\Gamma \der T \hiff T' : s \qquad
         \Gamma \der C \hiff C' : \Pi x:T. \Pi y:T. (x =_T y) \to s'
       }{\Gamma \der b \hiff b' : \Pi x:T. C\ x\ x\ \refl_x
       }{\Gamma \der u \hiff u' : T \qquad
         \Gamma \der v \hiff v' : T \qquad
         \Gamma \der n \steq n' : u =_T v
       }{\Gamma \der \J (T,C,b,u,v,n) \hsteq \J (T',C',b',u',v',n') :
         C\ u\ v\ n}
  \)
  \end{center}
  ...
  \(
    ...
    \qquad
    \ru{(U, \mathcal{B}) \in \widehat{\U_i}
      }{(\RRe{T}{U}{h}, \RRcal{\mathcal{B}}{h}) \in \U_i}
  \)
  \end{center}
