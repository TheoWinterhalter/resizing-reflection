...
\begin{document}
  ...
  Then the rules regarding resizing:

  \begin{center}
  \(
    \ru{\Gamma \der t : [\Type_i]_j
      }{\Gamma \der t \gettype : \Type_i}
    \qquad
    \ru{}{\Gamma \der [\Type_i]_j : \Type_j}
  \)
  \end{center}
...
\begin{align*}
  ...
  \Wne  &\ni n,N &::=~& x \mid n~u \mid n.1 \mid n.2 \mid n \gettype
\end{align*}
